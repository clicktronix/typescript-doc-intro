...
```
Имейте в виду, что нам не всегда нужно писать явные аннотации типов. Во многих случаях TypeScript может просто вывести (*infer*) или вычислить типы за нас, даже если мы их опустим.
```TypeScript
let msg = "hello there!";
//  ^ = let msg: string
```
